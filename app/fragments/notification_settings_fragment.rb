class NotificationSettingsFragment < Android::Support::V4::App::Fragment
  ...
  def get_title
    get_string('nav_notifications')
  end
    
  def load_views
    outlets['toggle_alert'].setChecked app_delegate.current_profile.push_notifications_active
  ...
  def onCheckedChanged(buttonView, isChecked)
    ...
    current_profile.push_notifications_active = isChecked
